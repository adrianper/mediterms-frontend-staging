...
const Institutions = () => {
	...
	const handleSumbit = () => {
		...
		if (
			...
			formData.positionAndDepartment != "" &&
	...
	useEffect(() => {
		...
		if (params === "true") setShowForm(true)
	}, [])
				...
				{showForm ? (
						...
						{successfulRequest ? (
							<Grid gap="1.71em">
								<Text>
									...
									<br /> En breve nos pondremos en contacto contigo vía correo electrónico para darte
									instrucciones de como obtener el descuento para tus estudiantes y que puedan empezar
									a usar MediTerms®.
								</Text>
								<Button selfCenter onClick={() => cleanInstitutes()}>
									Entendido
								</Button>
							</Grid>
						) : (
							<Grid gap="2.8em">
								<Grid gap="1.14em">
									...
									<Text>
										Para habilitar el descuento institucional a los alumnos, es necesario que se
										ponga en contacto con nosotros una de las autoridades educativas
										<br />
										<br />
										Acércate a la dirección de tu carrera y muestrales la información que aparece a
										continuación:
									</Text>
								</Grid>
								<Grid gap="1.14em">
									...
									<Text>
										Para habilitar el descuento institucional a los alumnos, es necesario que se
										ponga en contacto con nosotros a través del siguiente formulario.
									</Text>
									<Grid gap="1.21em">
										<TextField
										...
										/>
										{error !== "" && (
											<Text medium align="center" color="error">
												{error}
											</Text>
										)}
										<Grid
											...
											columns="auto auto"
											gap="1.71em">
											<Button className="second_button" onClick={() => cleanInstitutes()}>
												Regresar
											</Button>
											<Button type="submit" width="108px" onClick={handleSumbit}>
												Enviar
											</Button>
										</Grid>
									</Grid>
					...
					<Grid gap="1.71em">
						<Text bold size="5" align="center">
							Instituciones que ofrecen descuento a sus alumnos
						</Text>
						<Text
							...
							align="center"
							color="first">
							¿No encuentras a tu institución? <br />
							Contactanos
						</Text>
						{/*
                        ...
                        */}
						<Button onClick={() => navigate("/home")} selfCenter className="second_button">
							Regresar
						</Button>
					</Grid>
				)}
